...
- Auto-completion / IntelliSense for built-in and user-defined entities.
...
- **The `rtconfig.txt` file must end with a blank line:**
  - This is a limitation of the tooling being used. Currently, the parser cannot properly handle the end-of-file (EOF) marker and relies on a trailing newline character when parsing commands. This restriction is expected to be lifted in a future version.
